...
final class WishMakerViewController: UIViewController {
    ...
    private func configureSliders() {
        ...
        redSlider.valueChanged = { [weak self] _ in
            self?.updateBackgroundColor()
        }
        
        greenSlider.valueChanged = { [weak self] _ in
            self?.updateBackgroundColor()
        }
        
        blueSlider.valueChanged = { [weak self] _ in
            self?.updateBackgroundColor()
        }
    ...
    private func updateBackgroundColor() {
        ...
        print("Updating color - R: \(red), G: \(green), B: \(blue)")
